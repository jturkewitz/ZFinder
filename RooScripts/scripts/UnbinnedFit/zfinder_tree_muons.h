...
#ifndef zfinder_tree_muons_h
#define zfinder_tree_muons_h
...
class zfinder_tree {
  public :
    ...
    zfinder_tree_(TTree *tree=0);
    virtual ~zfinder_tree_();
