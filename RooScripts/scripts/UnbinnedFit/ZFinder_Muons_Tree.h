...
public :
   ...
   ZFinder_Muons_Tree(TTree *tree=0);
   virtual ~ZFinder_Muons_Tree();
...
#ifdef ZFinder_Muons_Tree_cxx
ZFinder_Muons_Tree::ZFinder_Muons_Tree(TTree *tree) : fChain(0) 
{
...
ZFinder_Muons_Tree::~ZFinder_Muons_Tree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ZFinder_Muons_Tree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ZFinder_Muons_Tree::LoadTree(Long64_t entry)
{
...
void ZFinder_Muons_Tree::Init(TTree *tree)
{
...
Bool_t ZFinder_Muons_Tree::Notify()
{
...
void ZFinder_Muons_Tree::Show(Long64_t entry)
{
...
Int_t ZFinder_Muons_Tree::Cut(Long64_t entry)
{
...
#endif // #ifdef ZFinder_Muons_Tree_cxx
