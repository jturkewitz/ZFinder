...
// Wed Nov 11 15:43:22 2015 by ROOT version 5.34/32
// from TTree zfinder_tree/zfinder_tree
// found on file: /data/whybee0a/user/turkewitz_2/test/turkewitz/TestFiles/ntuples_looser/jpsiTest451_MuOniaPartial2012B_dimuon8_eta24_ptsub25.root
//////////////////////////////////////////////////////////

#ifndef ZFinder_Jpsi_Tree_h
#define ZFinder_Jpsi_Tree_h
...
public :
   ...
   ZFinder_Jpsi_Tree(TTree *tree=0);
   virtual ~ZFinder_Jpsi_Tree();
...
#ifdef ZFinder_Jpsi_Tree_cxx
ZFinder_Jpsi_Tree::ZFinder_Jpsi_Tree(TTree *tree) : fChain(0) 
{
...
ZFinder_Jpsi_Tree::~ZFinder_Jpsi_Tree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ZFinder_Jpsi_Tree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ZFinder_Jpsi_Tree::LoadTree(Long64_t entry)
{
...
void ZFinder_Jpsi_Tree::Init(TTree *tree)
{
...
Bool_t ZFinder_Jpsi_Tree::Notify()
{
...
void ZFinder_Jpsi_Tree::Show(Long64_t entry)
{
...
Int_t ZFinder_Jpsi_Tree::Cut(Long64_t entry)
{
...
#endif // #ifdef ZFinder_Jpsi_Tree_cxx
