...
// Thu Nov 12 18:11:08 2015 by ROOT version 5.34/32
// from TTree zfinder_tree/zfinder_tree
// found on file: /data/whybee0a/user/turkewitz_2/test/turkewitz/TestFiles/jpsiTest463_DoubleElectron_jpsi2_1_2012.root
//////////////////////////////////////////////////////////

#ifndef ZFinder_Electrons_Tree_h
#define ZFinder_Electrons_Tree_h
...
public :
   ...
   ZFinder_Electrons_Tree(TTree *tree=0);
   virtual ~ZFinder_Electrons_Tree();
...
#ifdef ZFinder_Electrons_Tree_cxx
ZFinder_Electrons_Tree::ZFinder_Electrons_Tree(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/data/whybee0a/user/turkewitz_2/test/turkewitz/TestFiles/jpsiTest507_z_40_300_DoubleElectron.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/data/whybee0a/user/turkewitz_2/test/turkewitz/TestFiles/jpsiTest507_z_40_300_DoubleElectron.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/data/whybee0a/user/turkewitz_2/test/turkewitz/TestFiles/jpsiTest507_z_40_300_DoubleElectron.root:/ZFinder");
      //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/data/whybee0a/user/turkewitz_2/test/turkewitz/TestFiles/jpsiTest481_double_e_sideband_combined.root");
      //if (!f || !f->IsOpen()) {
      //   f = new TFile("/data/whybee0a/user/turkewitz_2/test/turkewitz/TestFiles/jpsiTest481_double_e_sideband_combined.root");
      //}
      //TDirectory * dir = (TDirectory*)f->Get("/data/whybee0a/user/turkewitz_2/test/turkewitz/TestFiles/jpsiTest481_double_e_sideband_combined.root:/ZFinder");
...
ZFinder_Electrons_Tree::~ZFinder_Electrons_Tree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ZFinder_Electrons_Tree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ZFinder_Electrons_Tree::LoadTree(Long64_t entry)
{
...
void ZFinder_Electrons_Tree::Init(TTree *tree)
{
...
Bool_t ZFinder_Electrons_Tree::Notify()
{
...
void ZFinder_Electrons_Tree::Show(Long64_t entry)
{
...
Int_t ZFinder_Electrons_Tree::Cut(Long64_t entry)
{
...
#endif // #ifdef ZFinder_Electrons_Tree_cxx
